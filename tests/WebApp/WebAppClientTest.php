...
class WebAppClientTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->webAppClientWithCredentials = new WebAppClient(
            array('headers' => array('domain' => 'https://purplepay.crossborder.fedex.com')),
            WebAppClient::BASE_URL,
        ...
        $credentials = new Credentials($_SERVER['FCB_CLIENT_ID'], $_SERVER['FCB_CLIENT_SECRET'], $_SERVER['FCB_PARTNER_KEY']);
        $this->oauthClient = new OAuthClient($credentials, 'https://secure.crossborder.fedex.com');
        ...
        $this->webAppClientWithBearer->setPartnerKey($_SERVER['FCB_PARTNER_KEY']);
    }
